...
app = new (require('./server.js'))("../0-Config/configHTTPS");  // class where the work gets done
...
async function startServer() {
  ...
  app.https.createServer(
    ...
    key:  app.fs.readFileSync('../0-Config/certificates/private.key.pem')
   ,cert: app.fs.readFileSync('../0-Config/certificates/domain.cert.pem')
   ,ca:   app.fs.readFileSync('../0-Config/certificates/intermediate.cert.pem')
